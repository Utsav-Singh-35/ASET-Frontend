...
const WelcomeScreen = ({ userName, onSendMessage }) => {
    ...
    const suggestionCards = [
        {
            title: 'Climate Facts',
            description: 'Verify claims about climate change and environmental issues',
            prompt: 'Is climate change caused by human activity?'
        },
        {
            title: 'Health Claims',
            description: 'Check medical and health-related information',
            prompt: 'Are COVID-19 vaccines safe and effective?'
        },
        {
            title: 'Science & History',
            description: 'Fact-check scientific and historical statements',
            prompt: 'Did humans land on the moon in 1969?'
        }
    ];
